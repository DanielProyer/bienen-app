...
const materialAlternatives = <String, List<ProductAlternative>>{
  ...
  'Stockwaage digital': [
    ProductAlternative(
      ...
      pros: ['Schweizer Produkt & Support', '4G funktioniert garantiert in Arosa', 'Plug & Play, keine Konfiguration', 'Temperaturbereich -35°C bis +65°C', 'App mit Push-Benachrichtigungen'],
  ...
  'Nassenheider Professional Verdunster': [
    ProductAlternative(
      ...
      cons: ['Nur bei >15°C einsetzbar', 'Temperaturabhängige Wirkung'],
      isRecommended: true,
    ),
    ProductAlternative(
      ...
      cons: ['Teurer pro Behandlung', 'Kann bei Hitze Königinnenverlust verursachen', 'Nicht bei >29°C anwenden'],
    ),
    ProductAlternative(
  ...
  'Einlöttrafo BPS Basic': [
    ...
    ProductAlternative(
      name: 'Dampfwachsschmelzer + fertige MW',
      supplier: 'Wespi',
      price: 'CHF 200.00+',
      url: 'https://www.wespi-imkerei.ch',
      pros: ['Kein Einlöten nötig bei Naturwabenbau', 'Wachsrecycling möglich'],
      cons: ['Teuer', 'Naturwabenbau nicht für Anfänger', 'Komplett anderer Ansatz'],
    ),
  ],
