...
final _seedData = [
  ...
  const MaterialItem(id: '15', category: 'Honigverarbeitung', name: 'Honigschleuder Logar 20/8 Radial', description: '20 Halbrahmen / 4 Brutwaben, 110W Groschopp Motor, Ø63cm Kessel, AISI 304, 39kg', quantity: 1, unit: 'Stk', priceCHF: 1550.00, supplier: 'honigschleudern.eu', supplierUrl: 'https://www.honigschleudern.eu', phase: 2, status: 'offen', sortOrder: 30),
