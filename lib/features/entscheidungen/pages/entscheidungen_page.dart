      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildOpenItem(context, 'Bienenrasse (Abklärung Bündner Imkerverband)'),
            _buildOpenItem(context, 'Unterstand: Masse + Fotos auswerten'),
            _buildOpenItem(context, 'Stall OG: Masse + Fotos auswerten'),
            _buildOpenItem(context, 'Lieferant für Beuten (Wespi vs. bienenbeuten.ch)'),
