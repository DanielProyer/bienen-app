...
const kBuildSteps = <BuildStepContent>[
  BuildStepContent(
    ...
    instructions: [
      'Douglasie-Rahmenholz zuschneiden: 4× 1,4 m (untere Lagen) und je Balken für die obere Lage 0,7 + 1,4 + 0,7 m.',
      'Untere Lage je Balkenseite: 1,4 m + 1,4 m (Stoss mittig) auslegen.',
      'Obere Lage versetzt darauf: 0,7 + 1,4 + 0,7 m (Stösse bei 0,7 & 2,1 m) – so liegen die Stösse nie übereinander.',
      'Beide Lagen mit D4-Leim bestreichen und alle ~20 cm mit 8×100-Schrauben (versetzt) verschrauben.',
      'Ergebnis: 2 durchgehende Doppelbalken à 2,8 m.',
    ],
    soll: 'Stösse nie übereinander; Balken gerade, kein Verzug.',
    tip: 'D4-Leim ist wasserfest – Kontaktflächen vollflächig bestreichen.',
    drawings: ['assets/bau/01_doppelbalken_stoss.png'],
  ),
  BuildStepContent(
    key: 'rechteck',
